...
$routes->get('grid-asigna-membresia', 'Membresia::grid_asigna_membresia');
...
$routes->post('update-membresia', 'Membresia::update_membresia');
...
$routes->post('transfer_membership', 'Membresia::transfer_membership');
